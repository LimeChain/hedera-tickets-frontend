...
export const RegistrationView = function (context) {
    return (
        < div >
            <div className="row">
                <div className="col">
                    <form className="form-inline justify-content-center">
                        ...
                        <div className="form-group mx-sm-3 mb-2">
                            <input type="password" className="form-control" onChange={context.onPassword} placeholder="Password" />
                        </div>

                        <button type="button" className="btn btn-success mb-2" onClick={context.process}>Sign up</button>
                    </form>
